...
export class DisclaimerPage implements OnInit {
    ...
    getData(){
      ...
      this.disclaimer = "<p></p><p>All of the information on this website is published in good faith and is for general information purposes only. " + this.pageName + " does not make any warranties about the completeness, reliability and accuracy of this information. Any action you take upon the information you find on this website (<a style='color: #bc2027; font-weight: 700; text-decoration: inherit;' href='"+this.pageLink+"'>"+this.pageLinkName+"</a>) is strictly at your own risk. " + this.pageName + " will not be liable for any losses and/or damages in connection with the use of our website.</p><p>From our website, you can visit other websites by following hyperlinks to external sites. While we strive to provide only quality links to useful and ethical websites, we have no control over the content and nature of these sites. Any links to other websites do not imply a recommendation for all the content found on these sites. Site owners and content may change without notice and may occur before we have the opportunity to remove a bad link.</p><p>Be aware that when you leave " + this.pageName + ", other sites may have different privacy policies and terms, which are beyond our control. Please be sure to check the Privacy Policies of these sites as well as their Terms of Service before engaging in any business or uploading any information.</p><br/><div class='global-page-desc-headline'><b>Consent</b></div><p>By using <a style='color: #bc2027; font-weight: 700; text-decoration: inherit;' href='"+this.pageLink+"'>"+this.pageLinkName+"</a>, you hereby consent to our disclaimer and agree to its terms.</p><br/><div class='global-page-desc-headline'><b>Update</b></div><p>This site disclaimer was last updated on Monday, March 21, 2016. </p><p><span style='font-style: italic;'>Should we update, amend or make any changes to this document, those changes will be prominently posted here.</span></p><br/><div class='global-page-desc-headline'><b>Contact Us</b></div><p>If you need more information, or if you have any questions about our site's disclaimer, please feel free to contact us at <a style='color: #bc2027; font-weight: 700; text-decoration: inherit;' href='"+contactUsLink+"'>"+contactUsLinkName+"</a>.</p><br/>";
    }
